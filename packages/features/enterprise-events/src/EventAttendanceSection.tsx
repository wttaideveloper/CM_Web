...
import EventBatchCheckInSection from "./EventBatchCheckInSection";
...
export default function EventAttendanceSection({ eventId, eventStatus, timeZone }: { eventId: string; eventStatus: EventStatus; timeZone: string }) {
  ...
  return <section className="space-y-5">
    ...
    <EventBatchCheckInSection eventId={eventId} enabled={attendanceOperational} timeZone={timeZone} />
