...
export default function PlatformEnterpriseTypesScreen({
  onboardingFormsHref = "/onboarding-forms",
}: {
  onboardingFormsHref?: string;
}) {
  return (
        ...
        <div className="mt-5 grid gap-6 xl:grid-cols-2">
          {providerTypeCards.map((card, index) => (
            <ProviderTypeCardView
              ...
              onboardingFormsHref={onboardingFormsHref}
            />
          ))}
        </div>
      </div>
