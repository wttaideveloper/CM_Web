...
export { default as PlatformTrainingDetailsScreen } from "./PlatformTrainingDetailsScreen";
export { default as PlatformProgramsScreen } from "./PlatformProgramsScreen";
