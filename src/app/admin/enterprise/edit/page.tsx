...
const items = ["Business information", "Contact details", "Address details", "Branding assets"];
  ...
  return (
    <AppShell>
      <div className="w-full max-w-4xl">
        ...
        <h2 className="mt-2 text-2xl font-bold text-[#06201c] sm:text-3xl">Edit Enterprise</h2>
