...
export type FormConfigurationListItem = { id: string; name: string; description: string | null; scope: string; status: string; active: boolean; currentVersion: number; createdAt?: string | null; updatedAt: string | null; publishedAt: string | null };
