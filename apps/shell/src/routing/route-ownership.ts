export const ROUTE_PATHS = {
  ...
  platform: {
    ...
    formBuilder: "/form-builder-new",
    workflowBuilder: "/workflow-builder-new",
    formConfigurations: "/form-configurations",
    trainingForms: "/training-forms",
    trainingFormConfigurations: "/training-form-configurations",
...
const platformRouteRoots = [
  ...
  ROUTE_PATHS.platform.formBuilder,
  ROUTE_PATHS.platform.workflowBuilder,
  ROUTE_PATHS.platform.formConfigurations,
  ROUTE_PATHS.platform.trainingForms,
  ROUTE_PATHS.platform.trainingFormConfigurations,
  ...
  ROUTE_PATHS.platform.users,
  ROUTE_PATHS.platform.superAdmins,
