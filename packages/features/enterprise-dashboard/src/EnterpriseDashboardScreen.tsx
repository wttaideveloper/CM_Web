...
export type EnterpriseDashboardRoutes = {
...
type EnterpriseDashboardScreenProps = {
  routes: EnterpriseDashboardRoutes;
};
...
export default function EnterpriseDashboardScreen({ routes }: EnterpriseDashboardScreenProps) {
          ...
          <div className="space-y-2.5">
            {quickActions.map((item) => (
              <Link
                ...
                href={
                  item === "Create Product"
                    ? routes.createProductHref
                    : item === "Create Service"
                      ? routes.createServiceHref
                      : item === "Schedule Event"
                        ? routes.eventsHref
                        : item === "Add Training Course"
                          ? routes.trainingsHref
                          : item === "View Analytics"
                            ? routes.analyticsHref
                            : routes.integrationsHref
                }
