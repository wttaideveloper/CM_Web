...
/** One backend-authoritative Event taxonomy entry. Parent categories have no parent_id. */
...
/** The Event Categories API returns a plain, ordered collection. */
export type EventCategoriesResponse = readonly EventCategory[];
