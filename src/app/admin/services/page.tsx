...
const items = ["Service list placeholder", "Create service", "Availability", "Booking status"];
  ...
  return (
    <AppShell>
      <div className="w-full max-w-4xl">
        ...
        <h2 className="mt-2 text-2xl font-bold text-[#06201c] sm:text-3xl">Services</h2>
        <p className="mt-2 max-w-2xl text-sm leading-6 text-[#52736a] sm:text-base">
          Manage services offered by your enterprise.
        </p>
