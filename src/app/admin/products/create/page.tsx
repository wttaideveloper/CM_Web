...
const items = ["Product information", "Pricing details", "Category", "Images"];
  ...
  return (
    <AppShell>
      <div className="w-full max-w-4xl">
        ...
        <h2 className="mt-2 text-2xl font-bold text-[#06201c] sm:text-3xl">Create Product</h2>
        <p className="mt-2 max-w-2xl text-sm leading-6 text-[#52736a] sm:text-base">
          Add a new product for your enterprise.
        </p>
