...
function BuildingIcon() {
  return <svg aria-hidden="true" className="h-4 w-4" viewBox="0 0 24 24" fill="none"><path d="M4 21V4h10v17M14 8h6v13M7 7h.01M10 7h.01M7 10h.01M10 10h.01M7 13h.01M10 13h.01M7 16h.01M10 16h.01M17 11h.01M17 14h.01M17 17h.01" stroke="currentColor" strokeWidth="2" strokeLinecap="round" strokeLinejoin="round" /></svg>;
}

function UsersIcon() {
  return <svg aria-hidden="true" className="h-4 w-4" viewBox="0 0 24 24" fill="none"><path d="M17 21v-2a4 4 0 0 0-4-4H7a4 4 0 0 0-4 4v2M17 7a4 4 0 1 1-8 0 4 4 0 0 1 8 0Zm5 14v-2a4 4 0 0 0-3-3.87M17 4.13a4 4 0 0 1 0 7.74" stroke="currentColor" strokeWidth="2" strokeLinecap="round" strokeLinejoin="round" /></svg>;
}
  ...
  return (
    <div className="w-full min-w-0 overflow-x-hidden">
      ...
      <div className="grid w-full min-w-0 grid-cols-1 gap-4 md:grid-cols-2 xl:grid-cols-4">
        {stats.map((item, index) => <div key={item.label} className="group min-h-[142px] w-full min-w-0 rounded-2xl border border-[#e1ebe6] bg-white p-5 shadow-sm transition-all duration-200 hover:bg-gradient-to-br hover:from-[#1f6a58] hover:to-[#8fc9a8] hover:shadow-md"><div className="mb-4 flex items-center justify-between"><div className="flex h-10 w-10 items-center justify-center rounded-xl bg-[#e8f6ee] text-[#1f6a58] transition-all duration-200 group-hover:bg-white/20 group-hover:text-white">{index === 0 ? <BuildingIcon /> : index === 1 ? <RevenueIcon /> : index === 2 ? <UsersIcon /> : <PackageIcon />}</div>{item.change ? <span className="flex items-center gap-1 text-xs font-bold text-[#08a36b] transition-all duration-200 group-hover:text-white"><MiniArrow />{item.change}</span> : null}</div><h3 className="text-2xl font-bold text-[#06201c] transition-colors duration-200 group-hover:text-white">{item.value}</h3><p className="mt-1 text-sm font-normal text-[#52736a] transition-colors duration-200 group-hover:text-white">{item.label}</p>{"subtitle" in item ? <p className="mt-1 text-xs font-medium text-[#7f9d94] transition-colors duration-200 group-hover:text-white/90">{item.subtitle}</p> : null}</div>)}
      </div>
